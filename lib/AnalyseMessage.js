...
var AnalyseMessage = (function () {
  ...
  _createClass(AnalyseMessage, [{
    ...
    value: function _connection(content) {
      var analyseContent = new _AnalyseContentAddJs2['default'](content, this._context);
      analyseContent.init();
    ...
    value: function _slaveDisconnected(content) {
      var analyseContent = new _AnalyserContentRemoveJs2['default'](content, this._context);
      analyseContent.init();
      console.log(this._context._slaves); // TODO: Can be deleted
    }
  }, {
