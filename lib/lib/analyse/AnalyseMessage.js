...
var _DeviceRole = require('../DeviceRole');

var _DeviceRole2 = _interopRequireDefault(_DeviceRole);
...
var AnalyseMessage = (function () {
  ...
  _createClass(AnalyseMessage, [{
    ...
    value: function _identification(content) {
      ...
      this._connectCb(new _DeviceRole2['default'](this._context._messageOut, this._context._messageIn, this._context['role']));
    }
  }, {
    key: '_connection',
