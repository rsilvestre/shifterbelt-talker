...
var ExchangeManager = (function (_Exchanger) {
  function ExchangeManager(messageOut, messageIn, role) {
    _classCallCheck(this, ExchangeManager);

    _get(Object.getPrototypeOf(ExchangeManager.prototype), 'constructor', this).call(this, messageOut, messageIn, role);
  }
